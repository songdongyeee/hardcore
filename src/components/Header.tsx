...
export function Header({ onNavigateHome, className }: HeaderProps) {
  return (
    <header className={cn("absolute top-0 left-0 right-0 z-50 px-6 py-6 flex justify-between items-center bg-gradient-to-b from-black/80 to-transparent pointer-events-none", className)}>
      <div 
